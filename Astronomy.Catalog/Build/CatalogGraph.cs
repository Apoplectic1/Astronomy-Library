...
/// → templates → targets → plans → inventory; within <see cref="Targets"/>, a mosaic's panel children always
/// follow their parent (the self-referencing FK requires parents-before-children). Every
/// <see cref="ExposurePlan.TargetId"/> and <see cref="InventoryFilter.TargetId"/> points at a
/// <see cref="Target"/> in <see cref="Targets"/>.
/// </summary>
