...
- **2026-08-11** — WinForms shell invoke-time capture shipped and reverted same day (user decision): the uniform cross-consumer hotkey contract is **capture at OK time only** — TSM/TP/XFM identical; transient-UI shots stay on the delayed-capture workflow. Net code change: none (see CHANGELOG).
