...
namespace Astronomy.Core.Tests.Tests
{
    ...
    public class MoonSeparationObserveAtTests
    {
        ...
        {
            var (sep, _, _) = MoonSeparation.ObserveAt(Target.Default, TestLocations.PennsPark, SampleUtc);
            double sepFromDegreesAt = MoonSeparation.DegreesAt(Target.Default, TestLocations.PennsPark, SampleUtc);
        ...
        {
            var (_, moonAlt, _) = MoonSeparation.ObserveAt(Target.Default, TestLocations.PennsPark, SampleUtc);
        ...
        public void ObserveAt_NullTarget_Throws()
        {
            Assert.Throws<ArgumentNullException>(
                () => MoonSeparation.ObserveAt(null, TestLocations.PennsPark, SampleUtc));
        }
